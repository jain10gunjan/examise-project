...
export default function Jobs({
  searchParams: { work, experience, type, location },
}: PageProps) {
  ...
  return (
    <div className="max-w-5xl m-auto px-3 my-10 space-y-10">
      <div className="relative z-10 container px-4 mx-auto">
        ...
        <p className="mb-20 text-gray-600 font-medium leading-relaxed md:max-w-md">
          Find Your Dream Job Today: Unlock Endless Possibilities and Achieve
          Your Career Goals
        </p>
      </div>
